    ...
    public AgentResponse processMessage(String userMessage, String discordUsername) {
        ...
        if (toolUseBlock == null) {
            ...
            return new AgentResponse(
                    text.isEmpty() ? "I can help you manage the Minecraft server and answer questions about the OMCSI infrastructure. I can start, stop, or restart the server, check its status, view performance metrics, check player activity stats and the leaderboard, trigger backups, run diagnostics, and provide information about the infrastructure's services, architecture, and configuration. What would you like to do?" : text,
                    false, null, null, null, userMessage, null);
        }
        ...
        if (!toolExecutionService.isRecognizedTool(toolName)) {
            ...
            return new AgentResponse(
                    "I'm sorry, I don't have the ability to perform that action. I can start, stop, or restart the server, check its status, view performance metrics, check player activity stats and the leaderboard, trigger backups, run diagnostics, and provide information about the OMCSI infrastructure.",
                    false, null, null, null, userMessage, null);
        }
